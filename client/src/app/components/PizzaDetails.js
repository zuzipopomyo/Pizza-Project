    ...
    <div className="flex flex-col lg:flex-row lg:gap-x-8 h-full md:p-8">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="px-2 py-4 border-t border-gray-200">
          <button onClick={()=>addToCart(pizza.id,pizza.image,pizza.name,price,additionalTopping,size,crust)} className="btn btn-lg gradient w-full flex justify-center items-center gap-x-2">
            <div>Add To Cart</div>
            <div>${price}</div>
          </button>
        </div>
